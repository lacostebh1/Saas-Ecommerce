...
export const UI = {
  fr: {
    announce: '🚚 Livraison OFFERTE en France, Belgique, Espagne, Italie, Pays-Bas, Pologne, Roumanie & Bulgarie — Offre de lancement −25%',
    headerCta: 'Commander',
    hero: {
    ...
    faq: {
      ...
      items: [
        ...
        ['Quels sont les délais de livraison ?', 'Expédition sous 24-48h, livraison suivie en 7 à 14 jours ouvrés en France, Belgique, Espagne, Italie, Pays-Bas, Pologne, Roumanie et Bulgarie. Un numéro de suivi vous est envoyé par e-mail.'],
    ...
    form: {
      ...
      countries: { France: 'France', Belgique: 'Belgique', Espagne: 'Espagne', Italie: 'Italie', 'Pays-Bas': 'Pays-Bas', Pologne: 'Pologne', Roumanie: 'Roumanie', Bulgarie: 'Bulgarie' },
    },
    footer: {
  ...
  es: {
    announce: '🚚 Envío GRATIS a Francia, Bélgica, España, Italia, Países Bajos, Polonia, Rumanía y Bulgaria — Oferta de lanzamiento −25%',
    headerCta: 'Pedir',
    hero: {
    ...
    faq: {
      ...
      items: [
        ...
        ['¿Cuáles son los plazos de entrega?', 'Salida en 24-48h, entrega con seguimiento en 7-14 días laborables en Francia, Bélgica, España, Italia, Países Bajos, Polonia, Rumanía y Bulgaria. Recibirás un número de seguimiento por e-mail.'],
    ...
    form: {
      ...
      countries: { France: 'Francia', Belgique: 'Bélgica', Espagne: 'España', Italie: 'Italia', 'Pays-Bas': 'Países Bajos', Pologne: 'Polonia', Roumanie: 'Rumanía', Bulgarie: 'Bulgaria' },
    },
    footer: {
  ...
  it: {
    announce: '🚚 Spedizione GRATUITA in Francia, Belgio, Spagna, Italia, Paesi Bassi, Polonia, Romania e Bulgaria — Offerta di lancio −25%',
    headerCta: 'Ordina',
    hero: {
    ...
    faq: {
      ...
      items: [
        ...
        ['Quali sono i tempi di consegna?', 'Partenza in 24-48h, consegna tracciata in 7-14 giorni lavorativi in Francia, Belgio, Spagna, Italia, Paesi Bassi, Polonia, Romania e Bulgaria. Riceverai un numero di tracking via e-mail.'],
    ...
    form: {
      ...
      countries: { France: 'Francia', Belgique: 'Belgio', Espagne: 'Spagna', Italie: 'Italia', 'Pays-Bas': 'Paesi Bassi', Pologne: 'Polonia', Roumanie: 'Romania', Bulgarie: 'Bulgaria' },
    },
    footer: {
  ...
  nl: {
    announce: '🚚 GRATIS verzending naar Frankrijk, België, Spanje, Italië, Nederland, Polen, Roemenië en Bulgarije — Lanceeraanbieding −25%',
    headerCta: 'Bestellen',
    hero: {
    ...
    faq: {
      ...
      items: [
        ...
        ['Wat zijn de levertijden?', 'Verzending binnen 24-48u, levering met tracking in 7-14 werkdagen in Frankrijk, België, Spanje, Italië, Nederland, Polen, Roemenië en Bulgarije. Je ontvangt een trackingnummer per e-mail.'],
    ...
    form: {
      ...
      countries: { France: 'Frankrijk', Belgique: 'België', Espagne: 'Spanje', Italie: 'Italië', 'Pays-Bas': 'Nederland', Pologne: 'Polen', Roumanie: 'Roemenië', Bulgarie: 'Bulgarije' },
    },
    footer: {
  ...
  pl: {
    announce: '🚚 DARMOWA dostawa do Francji, Belgii, Hiszpanii, Włoch, Holandii, Polski, Rumunii i Bułgarii — Oferta startowa −25%',
    headerCta: 'Zamów',
    hero: {
    ...
    faq: {
      ...
      items: [
        ...
        ['Jakie są terminy dostawy?', 'Wysyłka w 24-48h, dostawa ze śledzeniem w 7-14 dni roboczych do Francji, Belgii, Hiszpanii, Włoch, Holandii, Polski, Rumunii i Bułgarii. Numer śledzenia otrzymasz e-mailem.'],
    ...
    form: {
      ...
      countries: { France: 'Francja', Belgique: 'Belgia', Espagne: 'Hiszpania', Italie: 'Włochy', 'Pays-Bas': 'Holandia', Pologne: 'Polska', Roumanie: 'Rumunia', Bulgarie: 'Bułgaria' },
    },
    footer: {
  ...
  ro: {
    announce: '🚚 Livrare GRATUITĂ în Franța, Belgia, Spania, Italia, Țările de Jos, Polonia, România și Bulgaria — Ofertă de lansare −25%',
    headerCta: 'Comandă',
    hero: {
    ...
    faq: {
      ...
      items: [
        ...
        ['Care sunt termenele de livrare?', 'Expediere în 24-48h, livrare cu urmărire în 7-14 zile lucrătoare în Franța, Belgia, Spania, Italia, Țările de Jos, Polonia, România și Bulgaria. Primești numărul de urmărire pe e-mail.'],
    ...
    form: {
      ...
      countries: { France: 'Franța', Belgique: 'Belgia', Espagne: 'Spania', Italie: 'Italia', 'Pays-Bas': 'Țările de Jos', Pologne: 'Polonia', Roumanie: 'România', Bulgarie: 'Bulgaria' },
    },
    footer: {
  ...
  bg: {
    announce: '🚚 БЕЗПЛАТНА доставка до Франция, Белгия, Испания, Италия, Нидерландия, Полша, Румъния и България — Промоция при старт −25%',
    headerCta: 'Поръчай',
    hero: {
    ...
    faq: {
      ...
      items: [
        ...
        ['Какви са сроковете за доставка?', 'Изпращане до 24-48ч, доставка с проследяване за 7-14 работни дни до Франция, Белгия, Испания, Италия, Нидерландия, Полша, Румъния и България. Получавате номер за проследяване по имейл.'],
    ...
    form: {
      ...
      countries: { France: 'Франция', Belgique: 'Белгия', Espagne: 'Испания', Italie: 'Италия', 'Pays-Bas': 'Нидерландия', Pologne: 'Полша', Roumanie: 'Румъния', Bulgarie: 'България' },
    },
    footer: {
